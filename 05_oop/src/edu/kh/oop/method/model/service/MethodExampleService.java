...
public class MethodExampleService {
	...
	public String method3() {
		...
		String str = ""; // 빈 문자열(내용은 없지만 참조하는 객체는 존재함) (null과 잘 구별할 것 !)
		
		str += "안녕하세요?\n";
		str += "오늘 점심 뭐드시나요?\n";
		str += "삼겹살이 먹고싶네요.\n";
		
		return str; // String타입의 str을 반환함
		// return : 현재 메서드를 종료하고, 메서드 호출부로 되돌아감
		
		// return 값; : 현재 메서드를 종료하고, 값을 가지고 메서드 호출부로 되돌아감
